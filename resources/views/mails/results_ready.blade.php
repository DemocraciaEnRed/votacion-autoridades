                    ...
                    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="440"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td><font style=" font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:14px; line-height:20px; color:#000000; text-align:left;">Ya se encuentran disponibles los resultados de la votación dentro de la plataforma de <strong style="font-weight:bold;">Democracias Cotidianas</strong>. Te invitamos a verlos, hace click en el siguiente botón:</font></td>
                                        </tr>
                                        <tr>
                                            <td height="30"></td>
                                        </tr>
                                        <tr>
                                            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="175"><a href="{{ $url }}" target="_blank" style="border:none;"><img src="{{ asset('img/mails/btn-ver_resultados.png') }}" width="175" height="49" style="display:block; border:none;"></a></td>
                                                        <td width="265"></td>
                                                    </tr>
                                                </table></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td><font style=" font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-style:italic; font-size:12px; line-height:20px; color:#000000; text-align:left;">Si el botón de “Ver resultados” no funciona, copia y pega el siguiente link en tu navegador: <br>
