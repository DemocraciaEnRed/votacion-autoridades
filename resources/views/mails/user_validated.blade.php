        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="440"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><font style=" font-family:Arial, Helvetica, sans-serif; font-weight:normal; font-size:14px; line-height:20px; color:#000000; text-align:left;">Hemos validado tu identidad para participar en la plataforma de <strong style="font-weight:bold;">Democracias Cotidianas</strong>. El día de la votación podrás ingresar con tu usuario y tu clave para participar.</font></td>
                </tr>
              <tr>
                <td height="15"></td>
                </tr>
