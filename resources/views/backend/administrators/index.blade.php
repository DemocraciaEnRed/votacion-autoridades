            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a class="btn btn-block btn-success btn-sm" href="{{ action('\App\Http\Controllers\Backend\AdministratorController@create') }}"><i class="fas fa-plus"></i> Nuevo</a>
                    </div>
                </div>
...
$(function () {
    ...
    var table = $('.administrators').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ action('\App\Http\Controllers\Backend\AdministratorController@index') }}",
        columns: [
            {
                data: 'name',
                name: 'name',
